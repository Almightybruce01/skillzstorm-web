  ...
  return (
    <div className="pt-20 sm:pt-24 page-enter min-h-[100vh] w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
      ...
      <div className="space-y-3 mb-8">
        <CoinPack icon="🪙" name="500 Coins" desc="Starter pack" price="$0.99" bonus="" onClick={() => handlePurchase(STRIPE_LINKS.coins500)} color="#f59e0b" delay="0.55s" />
        <CoinPack icon="💰" name="2,500 Coins" desc="Popular choice" price="$3.99" bonus="+250 BONUS" onClick={() => handlePurchase(STRIPE_LINKS.coins2500)} color="#f97316" delay="0.6s" />
        <CoinPack icon="💎" name="10,000 Coins" desc="Best per-coin value" price="$9.99" bonus="+2,000 BONUS" onClick={() => handlePurchase(STRIPE_LINKS.coins10000)} color="#8b5cf6" delay="0.65s" />
      </div>
