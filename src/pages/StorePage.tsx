...
const products: StoreProduct[] = [
  ...
  { id: '3d_basic', name: 'Storm3D Basic', description: 'Pack of 5 red/cyan 3D glasses. Works with all Storm3D games on any screen.', price: '$4.99', priceNum: 4.99, emoji: '👓', category: '3D Glasses', features: ['Pack of 5', 'Classic red/cyan', 'Works on any screen', 'Scratch-resistant'], inStock: true, isPhysical: true, accentColor: '#10b981' },
  { id: '3d_polarized', name: 'Storm3D Polarized', description: 'Polarized 3D glasses for color-accurate, comfortable viewing.', price: '$14.99', priceNum: 14.99, emoji: '🕶️', category: '3D Glasses', features: ['Polarized lenses', 'No color distortion', 'Comfortable fit', 'Durable frame'], inStock: true, isPhysical: true, accentColor: '#06b6d4' },
  { id: '3d_clip', name: 'Storm3D Clip-On', description: 'Clip-on 3D lenses for people who wear glasses.', price: '$9.99', priceNum: 9.99, emoji: '👁️', category: '3D Glasses', features: ['Clips onto glasses', 'Universal fit', 'Flip-up design', 'Anti-scratch coating'], inStock: true, isPhysical: true, accentColor: '#f59e0b' },
  ...
  { id: 'headphones', name: 'StormSound Buds', description: 'Wireless earbuds with low-latency gaming mode and spatial audio.', price: '$19.99', priceNum: 19.99, emoji: '🎵', category: 'Accessories', features: ['Low latency mode', 'Spatial audio', '4-hour battery', 'Sweat-resistant'], inStock: true, isPhysical: true, accentColor: '#8b5cf6' },
  { id: 'stand', name: 'StormStand', description: 'Adjustable tablet/phone stand for hands-free gaming.', price: '$12.99', priceNum: 12.99, emoji: '📱', category: 'Accessories', features: ['Adjustable angle', 'Foldable & portable', 'Anti-slip base', 'Fits all devices'], inStock: true, isPhysical: true, accentColor: '#f97316' },
];
    ...
    <div className="pt-20 sm:pt-24 page-enter min-h-[100vh] w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-32">
      ...
      <div className="glass-card p-8 mt-8 animate-slide-up">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <ShippingPerk icon="📦" title="2-3 Day Shipping" desc="Standard delivery" color="#3b82f6" />
